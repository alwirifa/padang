...
const UsersPage: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [
          ...
          axios.get(
            "https://giraffe-adjusted-severely.ngrok-free.app/api/admin/brand",
            {
              headers: {
                Authorization: `Bearer ${token}`,
                "ngrok-skip-browser-warning": "69420",
          ...
          axios.get(
            "https://giraffe-adjusted-severely.ngrok-free.app/api/admin/supplier",
            {
              headers: {
                Authorization: `Bearer ${token}`,
                "ngrok-skip-browser-warning": "69420",
  ...
  const handleDelete = async (id: number) => {
    try {
      const token = localStorage.getItem("token");
      await axios.delete(
        `https://giraffe-adjusted-severely.ngrok-free.app/api/admin/barang?id=${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "ngrok-skip-browser-warning": "69420",
  ...
  const handleUpdate = async (values: z.infer<typeof formSchema>) => {
    ...
    toast.promise(
      axios
        .put(
          `https://giraffe-adjusted-severely.ngrok-free.app/api/admin/barang?id=${selectedBarang.id}`,
          values,
          {
            headers: {
              Authorization: `Bearer ${token}`,
